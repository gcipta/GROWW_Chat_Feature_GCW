...
public class PlaceAutoCompleteAdapter {
    ...
    public class PlaceAutocompleteAdapter
        ...
        private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
            Log.i("getAutocomplete", "Starting autocomplete query for: " + constraint);
            ...
            try {
                ...
                Log.i("getAutocomplete",
                        "Query completed. Received " + autocompletePredictions.getCount()
                        + " predictions.");
                ...
                Log.e("getAutocomplete",
                        "Error getting autocomplete prediction API call", e);
                return null;
            }
        }
    }
