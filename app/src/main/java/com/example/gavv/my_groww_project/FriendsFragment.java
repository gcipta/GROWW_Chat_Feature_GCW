...
//                                                if(userRole.equals("helper") && mUsersDatabase.child("role").equals("helpee")){
//
//                                                    if(i == 2){
//                                                        Intent chatIntent = new Intent(getContext(), ChatActivity.class);
//                                                        chatIntent.putExtra("user_id", list_user_id);
...
//                                                DatabaseReference myRef = FirebaseDatabase.getInstance().getReference().child("users").child(FirebaseAuth.getInstance().getUid()).child("role");
//                                                String role;
//
...
//                View view = LayoutInflater.from(mMainView.getContext())
